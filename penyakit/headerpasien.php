 ...
 <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="../Dashboard/indexpasien.php">SP GIZI BURUK</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="../Dashboard/indexpasien.php">SP</a>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?= (strpos($current_url, '/Dashboard/') !== false) ? 'active' : ''; ?>">
                            <a class="nav-link" href="../Dashboard/indexpasien.php"><i class="fas fa-home"></i> <span>Home</span></a>
                        </li>
                        <li class="<?= (strpos($current_url, '/pasien/') !== false) ? 'active' : ''; ?>">
                            <a class="nav-link" href="../pasien/indexpasien.php"><i class="fas fa-user"></i> <span>Profil Saya</span></a>
                        </li>
                        <li class="<?= (strpos($current_url, '/penyakit/') !== false) ? 'active' : ''; ?>">
                            <a class="nav-link" href="../penyakit/indexpasien.php"><i class="fas fa-thermometer-half"></i> <span>Info Penyakit</span></a>
                        </li>
                        <li class="<?= (strpos($current_url, '/gejala/') !== false) ? 'active' : ''; ?>">
                            <a class="nav-link" href="../gejala/indexpasien.php"><i class="fas fa-notes-medical"></i> <span>Info Gejala</span></a>
                        </li>
                        
                        <li class="menu-header">Diagnosa</li>
                        <li class="<?= (strpos($current_url, '/diagnosa/') !== false) ? 'active' : ''; ?>">
                            <a class="nav-link" href="../diagnosa/indexpasien.php"><i class="fas fa-stethoscope"></i> <span>Mulai Diagnosa</span></a>
                        </li>
                        <li class="<?= (strpos($current_url, '/hasil/') !== false) ? 'active' : ''; ?>">
                            <a class="nav-link" href="../hasil/indexpasien.php"><i class="fas fa-file-medical-alt"></i> <span>Riwayat Hasil</span></a>
                        </li>
                    </ul>
                </aside>
            </div>