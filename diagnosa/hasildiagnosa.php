...
if (isset($_POST['submit']) && empty($_POST['gejala'])) {
    echo "<script>alert('Harap pilih minimal satu gejala!'); window.location.replace('index.php');</script>";
    exit;
}
...
if (isset($_POST['submit'])) {
    ...
    while ($row = mysqli_fetch_array($SqlQuery)) {
        ...
        $hasilakhir = $kali * 0.333333; // Const multiplier
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card bg-primary text-white text-center shadow-sm">
                    <div class="card-body">
                        <h5>Kemungkinan Terbesar Pasien Mengalami:</h5>
            ...
            <div class="col-12 col-md-6">
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        <form action="../hasil/index.php" method="GET">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">Hasil Nilai Naive Bayes</label>
                            ...
                            <div class="text-right mt-4">
                                <button class="btn btn-success btn-lg" type="submit" name="tambah"><i class="fas fa-save mr-1"></i> Simpan ke Riwayat Hasil</button>
                            </div>
                        </form>
                    </div>
                </div>
