                ...
                <nav class="navbar navbar-expand-lg main-navbar">
                    ...
                    <ul class="navbar-nav navbar-right">
                        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                                <img alt="image" src="https://ui-avatars.com/api/?name=<?= urlencode($_SESSION['username']); ?>&background=ffffff&color=0284c7" class="rounded-circle mr-1">
                ...
                <div class="main-sidebar">
                    <aside id="sidebar-wrapper">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li><a class="nav-link" href="../penyakit/index.php"><i class="fas fa-thermometer-empty"></i><span>Penyakit</span></a></li>
                            <li><a class="nav-link" href="../gejala/index.php"><i class="fas fa-notes-medical"></i><span>Gejala</span></a></li>
                            <li><a class="nav-link" href="../diagnosa/index.php"><i class="fas fa-stethoscope"></i><span>Diagnosa</span></a></li>
                            <li><a class="nav-link" href="../hasil/index.php"><i class="fas fa-file-medical-alt"></i><span>Hasil</span></a></li>
