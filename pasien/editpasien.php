            ...
            <div class="col-lg-8">
                <div class="card shadow-sm border-0">
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                        <h4 class="mb-0 text-primary">Update Data Anda</h4>
                        <a class="btn btn-light border btn-sm" href="indexpasien.php" title="Kembali"><i class="fas fa-arrow-left mr-1"></i> Kembali</a>
                    </div>
...
if (isset($_POST['submit'])) {
    ...
    echo "<script>
        Swal.fire({ icon: 'success', title: 'Berhasil!', text: 'Profil Anda berhasil diupdate.', showConfirmButton: false, timer: 2000 })
