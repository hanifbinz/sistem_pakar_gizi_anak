            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.php">SP GIZI BURUK</a>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a class="nav-link" href="../pasien/index.php"><i class="fas fa-user-injured"></i> <span>Pasien</span></a></li>
                        <li><a class="nav-link" href="../penyakit/index.php"><i class="fas fa-thermometer-half"></i> <span>Penyakit</span></a></li>
                        ...
                        <li><a class="nav-link" href="../hasil/index.php"><i class="fas fa-file-medical-alt"></i> <span>Hasil Diagnosa</span></a></li>
                    </ul>
                </aside>
            </div>