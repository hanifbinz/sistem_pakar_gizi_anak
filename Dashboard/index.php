                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            ...
                            <span>Gejala yang sering dialami pasien yang nantinya akan diproses untuk mengetahui diagnosa gizi buruk apa yang dialaminya secara akurat.</span><br>
                        </div>
                        <div class="card-body"></div>
                    </div>
                </div>
                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            ...
                            <span>Aplikasi ini dikembangkan untuk membantu mendeteksi secara dini diagnosis penyakit gizi buruk sesuai gejala yang dialami balita dengan menggunakan algoritma probabilitas Naive Bayes.</span>
                        </div>
                        <div class="card-body"></div>
                    </div>
                </div>
